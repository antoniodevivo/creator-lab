...
if(((!j.posts.length&&!j.imported)||j.posts.some(p=>!p.transcript&&!p.excludedReason))&&!providers.ffmpegAvailable())throw new Error('Install FFmpeg (ffmpeg and ffprobe must be on PATH), restart the server, then resume');
