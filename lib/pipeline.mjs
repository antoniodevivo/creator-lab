...
// Chosen per run in the New analysis form. Laya runs locally; Jev needs a TypeSafe key.
export const CLASSIFIERS=['laya','jev'];
...
const classifier=config.classifier||DEFAULT_CLASSIFIER;if(!CLASSIFIERS.includes(classifier))throw new Error('Choose Laya or Jev as the classifier');
